                ...
                <el-card>
                  ...
                  <div class="realtime-data">
                    <div class="data-stream">
                      <div v-for="(data, index) in realtimeData" :key="`${data.id}-${index}`" class="data-item" :class="data.status">
              ...
              <el-col :span="8">
                <el-card>
                  ...
                  <div class="alert-list">
                    <div v-for="(alert, index) in recentAlerts" :key="`${alert.id}-${index}`" class="alert-item" :class="alert.level">
