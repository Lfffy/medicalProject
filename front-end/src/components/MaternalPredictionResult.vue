    ...
    <div class="result-section comprehensive-risk">
      ...
      <div class="risk-gauge-container">
        <div class="risk-gauge">
          <div class="gauge-circle" :class="getRiskClass(predictionData?.comprehensive?.overall_risk_level || '未知')">
            <div class="gauge-value">{{ predictionData?.comprehensive?.overall_risk_score || 0 }}%</div>
            <div class="gauge-label">{{ predictionData?.comprehensive?.overall_risk_level || '未知' }}</div>
          </div>
        </div>
        <div class="risk-description">
          <p>{{ predictionData?.comprehensive?.risk_description || '暂无风险描述' }}</p>
        </div>
      </div>
    </div>
      ...
      <div class="risks-grid">
        ...
        <div class="risk-card">
          <div class="risk-card-header">
            ...
            <div class="risk-score" :class="getRiskClass(predictionData?.preeclampsia?.risk_level || '未知')">
              {{ predictionData?.preeclampsia?.risk_score || 0 }}%
            </div>
          </div>
          <div class="risk-card-body">
            <div class="risk-level">{{ predictionData?.preeclampsia?.risk_level || '未知' }}</div>
            <p class="risk-description">{{ predictionData?.preeclampsia?.description || '暂无描述' }}</p>
        ...
        <div class="risk-card">
          <div class="risk-card-header">
            ...
            <div class="risk-score" :class="getRiskClass(predictionData?.gestational_diabetes?.risk_level || '未知')">
              {{ predictionData?.gestational_diabetes?.risk_score || 0 }}%
            </div>
          </div>
          <div class="risk-card-body">
            <div class="risk-level">{{ predictionData?.gestational_diabetes?.risk_level || '未知' }}</div>
            <p class="risk-description">{{ predictionData?.gestational_diabetes?.description || '暂无描述' }}</p>
            <div class="risk-factors">
              <h6>主要风险因素：</h6>
              <ul>
        ...
        <div class="risk-card">
          <div class="risk-card-header">
            ...
            <div class="risk-score" :class="getRiskClass(predictionData?.preterm_birth?.risk_level || '未知')">
              {{ predictionData?.preterm_birth?.risk_score || 0 }}%
            </div>
          </div>
          <div class="risk-card-body">
            <div class="risk-level">{{ predictionData?.preterm_birth?.risk_level || '未知' }}</div>
            <p class="risk-description">{{ predictionData?.preterm_birth?.description || '暂无描述' }}</p>
            <div class="risk-factors">
              <h6>主要风险因素：</h6>
              <ul>
