  ...
  methods: {
    ...
    async loadOverviewData() {
      try {
        ...
        if (response.data.code === 200) {
          ...
          this.patientTrendConfig = { data: data.patientTrend }
          this.diseaseDistributionConfig = { data: data.diseaseDistribution }
    ...
    async loadMedicalData() {
      try {
        ...
        if (response.data.code === 200) {
          const data = response.data.data
          this.medicalStats = data.medicalStats
          this.departmentConfig = { data: data.departmentData }
          this.diseaseTypeConfig = { data: data.diseaseTypeData }
          this.monthlyTrendConfig = { data: data.monthlyTrend }
          this.departmentData = data.departmentDetails
        }
      } catch (error) {
    ...
    async loadMaternalData() {
      try {
        ...
        if (response.data.code === 200) {
          const data = response.data.data
          this.maternalStats = data.maternalStats
          this.gestationalWeeksConfig = { data: data.gestationalWeeks }
          this.riskLevelConfig = { data: data.riskLevels }
          this.maternalData = data.maternalDetails
