  ...
  methods: {
    ...
    startMonitoringSession() {
      this.$refs.monitoringForm.validate(valid => {
        ...
        this.$http.post('/fetal-monitoring/start', this.monitoringForm)
          .then(response => {
...
.realtime-monitoring .monitoring-info {
  margin-bottom: 20px;
  padding: 15px;
...
.realtime-monitoring .info-item {
  display: flex;
  margin-bottom: 10px;
}

.realtime-monitoring .info-item label {
  font-weight: bold;
  color: #666;
  width: 80px;
}

.realtime-monitoring .info-item span {
  color: #333;
}

.realtime-monitoring .info-item .heart-rate {
  color: #FF6B6B;
  font-weight: bold;
  font-size: 18px;
}

.realtime-monitoring .realtime-chart {
  margin-bottom: 20px;
}

.realtime-monitoring .realtime-chart .chart {
  height: 400px;
}

.realtime-monitoring .monitoring-controls {
  text-align: center;
}

.realtime-monitoring .monitoring-controls .el-button {
  margin: 0 10px;
}
